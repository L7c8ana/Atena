...
project_name="AKimgClassifierDissolutionOrigClass1"
epochs = 100##0
ClassWeight = False
batch_size = 32
window_size = 41
...
if Train:
    ...
    with strategy.scope():
        ...
        if not AKCustom:
            auto_model = ak.ImageClassifier(overwrite=True, objective=objective, tuner=tuner, max_trials=max_trials, project_name=project_name, max_model_size= 60000000)##, multi_label=True) 
        else:
            inp1 = ak.ImageInput()
