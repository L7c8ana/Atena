...
project_name="AKDissolution_Merge" + tipImg[0] + "123"

pathmodel0 = os.path.join(data_dirResulst, "ResultTRAINWS41AKimgClassifierDissolution" + tipImg[0] + "Class0", "model_autokerasWS41")
pathmodel1 = os.path.join(data_dirResulst, "ResultTRAINWS41AKimgClassifierDissolution" + tipImg[0] + "Class1", "model_autokerasWS41")
pathmodel2 = os.path.join(data_dirResulst, "ResultTRAINWS41AKimgClassifierDissolution" + tipImg[0] + "Class2", "model_autokerasWS41")
epochs = 100##0
ClassWeight = False
batch_size = 32 * len(G)
window_size = 41
